...
export function MemoryGallery({ memories, onMemoryClick }: MemoryGalleryProps) {
      ...
      {memories.map((memory) => {
        ...
        return (
          <Card
            ...
            className="overflow-hidden border-2 border-pink-100 bg-white/70 backdrop-blur-md hover:shadow-xl hover:shadow-pink-100 transition-all duration-300 group cursor-pointer h-full flex flex-col hover:scale-[1.03] rounded-2xl"
          >
